...
const Starsbg = new Background("Starry Background", 1, true, "Stars.png", "#f0fafd", "#0a0f72","#060947", "A simplistic starry background to start your studying journey with! \n Spend your workdays gazing at a calming night sky background with shining white accents.");
