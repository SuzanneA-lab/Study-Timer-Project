...
const Starsbg = new Background("Starry Background", 20, true, "stars desc", "Stars.png", "#f0fafd", "#0a0f72","green");
const Oceanbg = new Background("Ocean Background", 1, false, "ocean desc", "Ocean.png", "#000686", "#f0fafd","yellow");
